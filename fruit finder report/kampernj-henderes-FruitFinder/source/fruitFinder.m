...
function [unprocessed_masks, fruit_masks, fruit_count, fruit_centroids, fruit_sizes] = fruitFinder(img)
    ...
    unprocessed_masks = containers.Map;
    ...
    for key = keys(fruit_filters)
        ...
        unprocessed_masks(ckey) = mask & makeMultiMaskFromRGB(img, fruit_filters(ckey));
